...
Автоматическая установка с помощью wee_extension:
  1. Загрузите последнюю версию Модуля https://github.com/ZVA90/weewx-rp5/releases
      wget -P /tmp https://github.com/ZVA90/weewx-rp5/releases/download/v0.5/weewx-rp5-0.5.tar.gz
  ...
  3. Установите модуль используя утилиту wee_extension
      cd /home/weewx/bin
      ./wee_extension --install=/tmp/weewx-rp5-0.5.tar.gz
